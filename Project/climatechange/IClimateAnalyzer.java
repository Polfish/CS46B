...
public interface IClimateAnalyzer {
    ...
    // the set is sorted from lowest to highest temperature// input parameter values are in Celsius
    ...
    // 2. The ClimateChange methods must be called in the order as listed in the[description section], (first with the
    // Task A methods, second are the Task B methods, and third are the Task C methods)
